...
export const TableNames = {
  ...
  DIVISION_MOVEMENTS: process.env.DIVISION_MOVEMENTS_TABLE!,
  EVENTS: process.env.EVENTS_TABLE!,
  EVENT_CHECK_INS: process.env.EVENT_CHECK_INS_TABLE!,
  ...
  FACTION_MESSAGES: process.env.FACTION_MESSAGES_TABLE!,
  FACTION_DIRECT_MESSAGES: process.env.FACTION_DIRECT_MESSAGES_TABLE!,
  RIVALRIES: process.env.RIVALRIES_TABLE!,
  RIVALRY_MESSAGES: process.env.RIVALRY_MESSAGES_TABLE!,
  RIVALRY_NOTES: process.env.RIVALRY_NOTES_TABLE!,
  MATCH_RATINGS: process.env.MATCH_RATINGS_TABLE!,
